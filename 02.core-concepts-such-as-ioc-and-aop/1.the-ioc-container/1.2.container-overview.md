...
> 基于 XML 的元数据不是允许配置元数据的唯一形式，Spring IoC 容器与实际写入配置元数据的格式是分离的。现在许多的开发者在他们的 Spring 应用中选择[基于 Java 配置](02.core-concepts-such-as-ioc-and-aop/1.the-ioc-container/1.12.java-based-container-configuration.md)。
